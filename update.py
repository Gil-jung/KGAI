...
nodes = [
    ...
    },
    {
        ...
        "markdown_content": open("Documents/PML1/01_introduction/00007_clustering.md", "r", encoding="utf-8").read()
    },
    {
        "name": "차원 축소",
        "category": "데이터 처리 기법",
        ...
        "markdown_content": open("Documents/PML1/01_introduction/00008_dimensionality_reduction.md", "r", encoding="utf-8").read()
    },
    {
        "name": "앙상블 학습",
        "category": "머신러닝 기법",
        ...
        "markdown_content": open("Documents/PML1/01_introduction/00009_ensemble_learning.md", "r", encoding="utf-8").read()
    },
    {
        "name": "신경망",
        "category": "머신러닝 모델",
        ...
        "markdown_content": open("Documents/PML1/01_introduction/00010_neural_networks.md", "r", encoding="utf-8").read()
    },
    {
        "name": "딥러닝",
        "category": "인공지능 기술",
        ...
        "markdown_content": open("Documents/PML1/01_introduction/00011_deep_learning.md", "r", encoding="utf-8").read()
    },
    {
        "name": "모델 평가",
        "category": "머신러닝 프로세스",
        ...
        "markdown_content": open("Documents/PML1/01_introduction/00012_model_evaluation.md", "r", encoding="utf-8").read()
    },
    {
        "name": "데이터",
        "category": "머신러닝 요소",
    ...
    },
    {
        ...
        "markdown_content": open("Documents/PML1/01_introduction/00014_feature_engineering.md", "r", encoding="utf-8").read()
    },
    {
        "name": "과적합과 과소적합",
        "category": "머신러닝 개념",
        ...
        "markdown_content": open("Documents/PML1/01_introduction/00015_overfitting_underfitting.md", "r", encoding="utf-8").read()
    },
    {
        "name": "하이퍼파라미터 튜닝",
        "category": "머신러닝 프로세스",
        ...
        "markdown_content": open("Documents/PML1/01_introduction/00016_hyperparameter_tuning.md", "r", encoding="utf-8").read()
    },
    {
        "name": "텍스트 데이터 전처리",
        "category": "데이터 처리 기법",
    ...
    },
    {
        ...
        "markdown_content": open("Documents/PML1/01_introduction/00018_preprocessing_image_data.md", "r", encoding="utf-8").read()
    },
    {
        ...
        "markdown_content": open("Documents/PML1/01_introduction/00019_time_series_analysis.md", "r", encoding="utf-8").read()
    }
]
